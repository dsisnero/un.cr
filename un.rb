...
def httpd
  setup('', 'BindAddress=ADDR', 'Port=PORT', 'MaxClients=NUM', 'TempDir=DIR',
        ...
        'SSLCertificate=CERT', 'SSLPrivateKey=KEY') do |argv, options|
    begin
      require 'webrick'
    rescue LoadError
    ...
    %i[Port MaxClients].each do |name|
      opt = options[name] and (options[name] = Integer(opt))
